...
const DocumentProcessor = () => {
  ...
  const {
    getRootProps: getAnalyzeRootProps,
    getInputProps: getAnalyzeInputProps,
    isDragActive: isAnalyzeDragActive,
  } = useDropzone({
  ...
  const {
    getRootProps: getTranslateRootProps,
    getInputProps: getTranslateInputProps,
    isDragActive: isTranslateDragActive,
  } = useDropzone({
  ...
  const downloadAsPDF = async (
    content: string,
    fileName: string,
    type: "generated" | "translated" = "generated"
  ) => {
    try {
  ...
  const updateDocContent = (id: string, newContent: string) => {
    setGeneratedDocs((prev) =>
      prev.map((doc) =>
        doc.id === id ? { ...doc, editedContent: newContent } : doc
      )
    );
  };
          ...
          <div className="max-w-md mx-auto py-16">
            <Card className="rounded-none bg-transparent">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Enter your Gemini API key to use AI-powered document
                  processing
                </CardDescription>
              </CardHeader>
      ...
      <div className="pt-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto py-8">
          <div className="mb-6 px-4 sm:px-6 md:px-0 text-center sm:text-left">
            <h1 className="text-2xl sm:text-2xl md:text-3xl font-bold leading-snug">
          ...
          <div className="mb-8 px-4 sm:px-0">
            <div className="flex flex-wrap sm:flex-nowrap border gap-2 p-2 w-full sm:w-fit overflow-x-auto justify-center">
              <button
                onClick={() => setActiveSection("analyze")}
                className={`flex items-center cursor-pointer space-x-2 px-4 py-2 text-xs sm:text-sm font-medium transition-colors ${
              ...
              <button
                ...
                className={`flex items-center cursor-pointer space-x-2 px-4 py-2 rounded-none text-xs sm:text-sm font-medium transition-colors ${
            ...
            <div className="space-y-6">
              <Card className="rounded-none bg-transparent">
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload PDF legal documents to get AI-powered analysis and
                    insights.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-200">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                              ...
                              <ul className="space-y-1 text-sm text-slate-600">
                                {doc.analysis.legalConcerns.map(
                                  (concern, index) => (
                                    <li
                                      key={index}
              ...
              {analyzedDocs.length === 0 && (
                <Card className="bg-transparent rounded-none border">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground/50">
                      Upload your first PDF document to get AI-powered analysis
                    </p>
                  </CardContent>
                </Card>
              )}
            ...
            <div className="space-y-6">
              <Card className="bg-transparent rounded-none">
                <CardHeader>
                  ...
                  <CardDescription>
                    Use AI to generate professional legal documents based on
                    your requirements
                  </CardDescription>
                </CardHeader>
                <CardContent className="relative space-y-4">
                  ...
                  <Button
                    ...
                    disabled={
                      isGenerating || !docType || !docTitle || !docDescription
                    }
                    className="w-full"
                  >
                    {isGenerating
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-200">
                          ...
                          {doc.isEditing ? (
                            <Textarea
                              ...
                              onChange={(e) =>
                                updateDocContent(doc.id, e.target.value)
                              }
              ...
              {generatedDocs.length === 0 && (
                <Card className="bg-transparent rounded-none">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground/50">
                      Fill in the form above to generate your first AI legal
                      document
                    </p>
                  </CardContent>
                </Card>
            ...
            <div className="space-y-6">
              <Card className="bg-transparent rounded-none">
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload PDF documents in foreign languages to translate them
              ...
              {translatedDocs.length === 0 && (
                <Card className="bg-transparent rounded-none">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground/50">
                      Select a target language and upload your first PDF
